...
@Command(name = "cql", description = "CQL generation operations", mixinStandardHelpOptions = true, subcommands = {
...
public class CqlCommand implements Runnable {
    ...
    static class FromDrool extends OperationCommand {
        @Override protected String getOperationName() { return "GenerateCQLFromDrool"; }
        @Override protected Operation createOperation() { return new GenerateCQLFromDroolOperation(); }
    }

    @Command(name = "from-vmr", description = "Transform vMR data to FHIR")
    static class FromVmr extends OperationCommand {
        @Override protected String getOperationName() { return "VmrToFhir"; }
        @Override protected Operation createOperation() { return new VmrToFhirOperation(); }
    }
}
