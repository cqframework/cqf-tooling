...
@Command(name = "bundle", description = "FHIR Bundle operations", mixinStandardHelpOptions = true, subcommands = {
...
public class BundleCommand implements Runnable {
    ...
    static class Resources extends OperationCommand {
        @Override protected String getOperationName() { return "BundleResources"; }
        @Override protected Operation createOperation() { return new BundleResources(); }
    }
    ...
    static class ToResources extends OperationCommand {
        @Override protected String getOperationName() { return "BundleToResources"; }
        @Override protected Operation createOperation() { return new BundleToResources(); }
    }
    ...
    static class ToTransaction extends OperationCommand {
        @Override protected String getOperationName() { return "MakeTransaction"; }
        @Override protected Operation createOperation() { return new BundleToTransactionOperation(); }
    }

    @Command(name = "post", description = "POST Bundles in a directory to a FHIR server")
    static class Post extends OperationCommand {
        @Override protected String getOperationName() { return "PostBundlesInDir"; }
        @Override protected Operation createOperation() { return new PostBundlesInDirOperation(); }
    }

    @Command(name = "publish", description = "Publish a Bundle")
    static class Publish extends OperationCommand {
        @Override protected String getOperationName() { return "PublishBundle"; }
        @Override protected Operation createOperation() { return new BundlePublish(); }
    }
}
