...
The operations defined in this package provide support for generating FHIR Library resources from CQL content.

## CqlToLibrary Operation

This operation transforms all CQL content in the specified directory or file into FHIR Library resources. The
resulting Library resource(s) will contain the following elements if applicable:
