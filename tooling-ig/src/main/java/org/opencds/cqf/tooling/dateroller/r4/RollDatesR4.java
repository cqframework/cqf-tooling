...
public class RollDatesR4 {
    ...
    public static void rollDatesInResource(IBaseResource resource) {
        ...
        logger.info("resource having date rolled:  "
                + r4Resource.getNamedProperty("id").getValues().get(0));
                                ...
                                if (propertyTypeCode.toLowerCase().contains("datetime")
                                    ...
                                    if (!resourceProperty.getValues().isEmpty()
                                        ...
                                        LocalDate dateToRole =
                                                DataDateRollerUtilsR4.getOldDateFromResource(r4Resource, field);
                                        if (null == dateToRole) {
                                            continue;
                                        }
                                        LocalDate newLocalDate =
                                                DataDateRollerUtilsR4.rollDate(dateToRole, dataDateRollerSettings);
                                        ...
                                        Property newProperty = new Property(
                                                ...
                                                values);
                                        Base newBase = r4Resource.makeProperty(
    ...
    private static void handlePeriod(
            Resource r4Resource, DataDateRollerSettingsR4 dataDateRollerSettings, String fieldName) {
