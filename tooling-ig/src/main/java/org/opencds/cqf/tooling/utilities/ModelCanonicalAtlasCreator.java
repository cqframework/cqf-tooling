...
public class ModelCanonicalAtlasCreator {
    ...
    public static CanonicalResourceAtlas createMainCanonicalAtlas(
            String resourcePaths, String modelName, String modelVersion, String inputPath) {
    ...
    public static CanonicalResourceAtlas createDependenciesCanonicalAtlas(
            String resourcePaths, String modelName, String modelVersion, String inputPath) {
    ...
    private static void setSystems(String inputPath, String resourcePath) {
        ...
        atlas.getStructureDefinitions()
                .forEach((key, structureDefinition) -> structureDefinitions.add(structureDefinition));
    }
