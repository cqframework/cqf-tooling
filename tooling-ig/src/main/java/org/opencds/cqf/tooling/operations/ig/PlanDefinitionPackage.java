...
public class PlanDefinitionPackage {
    ...
    public PlanDefinitionPackage(
            PlanDefinition r5PlanDefinition,
    ...
    public void addActivityDefinition(IBaseResource activityDefinition) {
        if (activityDefinition != null
                && this.activityDefinitions.stream()
                        .noneMatch(dep ->
                                ResourceUtils.compareResourceIdUrlAndVersion(activityDefinition, dep, fhirContext))) {
    ...
    public void addNestedPlanDefinition(IBaseResource planDefinition) {
        if (planDefinition != null
                && this.nestedPlanDefinitions.stream()
