    ...
    */
    ...
    public void resolvePrimaryLibraryDependencies(
        ...
        if (getPrimaryLibrary()
            ...
            // libraries
            if (primaryLibrary == null && mainArtifact.getIdElement() != null
                    && mainArtifact.getIdElement().getValue() != null) {
                logger.warn("Unable to resolve primary library for artifact {}",
                        mainArtifact.getIdElement().getValue());
            }
        ...
        if (includeDependencies) {
            if (primaryLibrary != null) {
                ...
                var dependencyLibraries =
                        ResourceUtils.getDepLibraryResources(
