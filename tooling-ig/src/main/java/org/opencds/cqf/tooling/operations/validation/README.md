...
The operations defined in this package provide support for validating FHIR resources against profiles.
...
- -packageurls | -purls (required) - Urls for the FHIR packages to use for validation as a comma-separated list
...
- -outputpath | -op (optional) - The directory path to which the transformed FHIR resources should be written
    - Default output path: replaces existing resources within the IG
