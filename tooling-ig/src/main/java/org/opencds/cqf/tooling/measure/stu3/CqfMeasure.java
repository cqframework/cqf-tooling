...
public class CqfMeasure extends Measure {
    ...
    public List<RelatedArtifact> getCitations() {
        if (this.citations == null) this.citations = new ArrayList<>();
    ...
    public List<ParameterDefinition> getParameter() {
        if (this.parameter == null) this.parameter = new ArrayList<>();
    ...
    public List<DataRequirement> getDataRequirement() {
        if (this.dataRequirement == null) this.dataRequirement = new ArrayList<>();
    ...
    public PopulationCriteriaMap getSharedPopulationCriteria() {
        if (this.sharedPopulationCriteria == null) this.sharedPopulationCriteria = new PopulationCriteriaMap();
        return this.sharedPopulationCriteria;
    }

    /**
     * @return Returns a reference to <code>this</code> for easy method chaining
     */
    public CqfMeasure setSharedPopulationCriteria(PopulationCriteriaMap theSharedPopulationCriteria) {
        this.sharedPopulationCriteria = theSharedPopulationCriteria;
        return this;
    }
    ...
    public CqfMeasure addSharedPopulationCriteria(String key, String display, String description) { // 3
        ...
        this.getSharedPopulationCriteria().getMap().put(key, Pair.of(display, description));
        return this;
    }
    ...
    public List<MeasureGroupComponent> getPopulationStatements() {
        if (this.populationStatements == null) this.populationStatements = new ArrayList<>();
    ...
    public List<MeasureGroupPopulationComponent> getDefinitionStatements() {
        if (this.definitionStatements == null) this.definitionStatements = new ArrayList<>();
    ...
    public List<MeasureGroupPopulationComponent> getFunctionStatements() {
        if (this.functionStatements == null) this.functionStatements = new ArrayList<>();
    ...
    public List<MeasureGroupPopulationComponent> getSupplementalDataElements() {
        if (this.supplementalDataElements == null) this.supplementalDataElements = new ArrayList<>();
    ...
    public List<TerminologyRef> getTerminology() {
        if (this.terminology == null) this.terminology = new ArrayList<>();
    ...
    public List<StringType> getDataCriteria() {
        if (this.dataCriteria == null) this.dataCriteria = new ArrayList<>();
    ...
    public CqfMeasure(Measure measure) {
        ...
        if (measure.getContributor() != null) {
            ...
            for (Contributor i : measure.getContributor()) contributor.add(i.copy());
        }
        ;
        ...
        if (measure.getLibrary() != null) {
            ...
            for (Reference i : measure.getLibrary()) library.add(i.copy());
        }
        ;
        ...
        improvementNotation = measure.getImprovementNotationElement() == null
                ? null
                : measure.getImprovementNotationElement().copy();
