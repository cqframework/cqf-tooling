...
public class IGBundleProcessor {
    ...
    public IGBundleProcessor(
            Boolean verboseMessaging, LibraryProcessor libraryProcessor, CDSHooksProcessor cdsHooksProcessor) {
        this.verboseMessaging = verboseMessaging;
        this.libraryProcessor = libraryProcessor;
        this.cdsHooksProcessor = cdsHooksProcessor;
    }

    public void bundleIg(
        ...
        new PackageMeasures(
                igPath, fhirContext, includeDependencies, includeTerminology, includePatientScenarios, fhirUri);
        //        new PlanDefinitionBundler(this.libraryProcessor,
        // this.cdsHooksProcessor).bundleResources(refreshedLibraryNames,
        //                igPath, binaryPaths, includeDependencies, includeTerminology,
        //                includePatientScenarios, versioned, addBundleTimestamp, fhirContext,
        //                fhirUri, encoding, verboseMessaging);
        new PackagePlanDefinitions(
                igPath, fhirContext, includeDependencies, includeTerminology, includePatientScenarios, fhirUri);
        new QuestionnaireBundler(this.libraryProcessor)
                .bundleResources(
