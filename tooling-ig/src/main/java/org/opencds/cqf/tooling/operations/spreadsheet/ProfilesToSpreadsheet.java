...
@Operation(name = "ProfilesToSpreadsheet")
public class ProfilesToSpreadsheet extends SpreadsheetBase {
    ...
    private void createOutput(List<StructureDefinitionBindingObject> bindingObjects) {
        ...
        SpreadsheetCreatorHelper.writeSpreadSheet(
                workBook,
                IOUtils.concatFilePath(outputPath, modelName + " " + modelVersion + " Profile Elements.xlsx"));
    }
