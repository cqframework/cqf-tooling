...
public class ExecuteMeasureTestOperation extends Operation {
    ...
    public void execute(String[] args) {
        ...
        try {
            ...
            // TODO: Need a proper ToString() for Parameters. The following results in: "org.hl7.fhir.Parameters cannot
            // be cast to org.hl7.fhir.instance.model.api.IBaseResource"
            //            String resource = IOUtils.encodeResourceAsString((IBaseResource)result, params.encoding,
            // fhirContext);
