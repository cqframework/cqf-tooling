...
public abstract class BaseNarrativeProvider<T extends INarrative> {
    ...
    public BaseNarrativeProvider() {
        this(Objects.requireNonNull(
                        Thread.currentThread().getContextClassLoader().getResource("narratives/narrative.properties"))
                .toString());
    }

    public BaseNarrativeProvider(String pathToPropertiesFile) {
        this.generator = new JarEnabledCustomThymeleafNarrativeGenerator(
                "classpath:ca/uhn/fhir/narrative/narratives.properties", pathToPropertiesFile);
    }
