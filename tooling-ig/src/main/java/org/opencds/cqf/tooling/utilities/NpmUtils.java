...
public class NpmUtils {
    ...
    public static PackageLoaderValidationSupport getNpmPackageLoaderValidationSupport(
            FhirContext fhirContext, List<String> packages) {
    ...
    public static org.hl7.fhir.r4.context.SimpleWorkerContext getR4WorkerContext(String packageUrl) {
        try {
            ...
            org.hl7.fhir.r4.context.SimpleWorkerContext workerContext =
                    org.hl7.fhir.r4.context.SimpleWorkerContext.fromPackage(npmPackage);
