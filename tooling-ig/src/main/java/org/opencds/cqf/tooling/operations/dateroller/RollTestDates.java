...
public class RollTestDates implements ExecutableOperation {
    ...
    public static final String DATEROLLER_EXT_URL =
            "http://fhir.org/guides/cdc/opioid-cds/StructureDefinition/dataDateRoller";

    @OperationParam(
            alias = {"ptres", "pathtoresources"},
            setter = "setPathToResources",
            description =
                    "Path to the directory containing the resource files to be updated (required if -ptreq not present)")
    private String pathToResources;

    @OperationParam(
            alias = {"ptreq", "pathtorequests"},
            setter = "setPathToRequests",
            description =
                    "Path to the directory containing the CDS Hooks request files to be updated (required if -ptres not present)")
    ...
    @OperationParam(
            ...
            defaultValue = "json",
            description =
                    "The file format to be used for representing the resulting resource { json, xml } (default json)")
    ...
    @OperationParam(
            ...
            description =
                    "The file system location where the resulting resources/requests are written (default same as -ptreq or -ptres)")
    ...
    public void execute() {
        ...
        if (pathToResources == null && pathToRequests == null) {
            throw new InvalidOperationArgs(
                    "Either pathtoresources (-ptres) or pathtorequests (-ptreq) parameter must be provided");
        }
        if (pathToResources != null) {
            ...
            List<IBaseResource> resources =
                    IOUtils.readResources(Collections.singletonList(pathToResources), fhirContext).stream()
                            .filter(resource -> ExtensionUtil.hasExtension(resource, DATEROLLER_EXT_URL))
    ...
    public void getUpdatedRequest(JsonObject request, Gson gson) {
        if (request.has("context") && request.get("context").getAsJsonObject().has("draftOrders")) {
            IBaseResource draftOrdersBundle = fhirContext
                    .newJsonParser()
                    .parseResource(request.getAsJsonObject("context")
                            .getAsJsonObject("draftOrders")
                            .toString());
                                ...
                                gson.fromJson(
                                        fhirContext
                                                ...
                                                .encodeResourceToString(
                                                        updateBundleDates((IBaseBundle) draftOrdersBundle)),
                                        JsonObject.class));
            }
        }
    ...
    // Library method
    public boolean getAllDateElements(
                        ...
                        if (theElement instanceof org.hl7.fhir.dstu3.model.BaseDateTimeType) {
                            ...
                            ((org.hl7.fhir.dstu3.model.BaseDateTimeType) theElement)
                                    .setValue(DateUtils.addDays(
                                            ((org.hl7.fhir.dstu3.model.BaseDateTimeType) theElement).getValue(),
                                            daysToAdd))
                            ...
                            ((org.hl7.fhir.r4.model.BaseDateTimeType) theElement)
                                    .setValue(DateUtils.addDays(
                                            ((org.hl7.fhir.r4.model.BaseDateTimeType) theElement).getValue(),
                                            daysToAdd))
                                    .setTimeZone(timeZone);
                            ...
                            ((org.hl7.fhir.r5.model.BaseDateTimeType) theElement)
                                    .setValue(DateUtils.addDays(
    ...
    private LocalDate getLastUpdatedDate(IBaseResource resource) {
        IBaseDatatype dateLastUpdated = ExtensionUtil.getExtensionByUrl(
                        ExtensionUtil.getExtensionByUrl(resource, DATEROLLER_EXT_URL), "dateLastUpdated")
                .getValue();
        if (dateLastUpdated instanceof org.hl7.fhir.dstu3.model.BaseDateTimeType) {
            return LocalDate.parse(((org.hl7.fhir.dstu3.model.BaseDateTimeType) dateLastUpdated)
                    .getValueAsString()
                    .split("T")[0]);
        } else if (dateLastUpdated instanceof org.hl7.fhir.r4.model.BaseDateTimeType) {
            return LocalDate.parse(((org.hl7.fhir.r4.model.BaseDateTimeType) dateLastUpdated)
                    .getValueAsString()
                    .split("T")[0]);
        } else if (dateLastUpdated instanceof org.hl7.fhir.r5.model.BaseDateTimeType) {
            return LocalDate.parse(((org.hl7.fhir.r5.model.BaseDateTimeType) dateLastUpdated)
                    .getValueAsString()
                    .split("T")[0]);
        } else {
            throw new IllegalArgumentException(
                    "Unsupported type/version found for dateLastUpdated extension: " + dateLastUpdated.fhirType());
        }
    }

    private int getFrequencyInDays(IBaseResource resource) {
        IBaseDatatype frequency = ExtensionUtil.getExtensionByUrl(
                        ExtensionUtil.getExtensionByUrl(resource, DATEROLLER_EXT_URL), "frequency")
                .getValue();
        int numDays;
        String precision;
        if (frequency instanceof org.hl7.fhir.dstu3.model.Duration) {
            ...
            precision = StringUtils.firstNonEmpty(
                    ((org.hl7.fhir.dstu3.model.Duration) frequency).getCode(),
                    ((org.hl7.fhir.dstu3.model.Duration) frequency).getUnit());
            ...
            precision = StringUtils.firstNonEmpty(
                    ((org.hl7.fhir.r4.model.Duration) frequency).getCode(),
                    ((org.hl7.fhir.r4.model.Duration) frequency).getUnit());
            ...
            precision = StringUtils.firstNonEmpty(
                    ((org.hl7.fhir.r5.model.Duration) frequency).getCode(),
                    ((org.hl7.fhir.r5.model.Duration) frequency).getUnit());
        } else {
            throw new IllegalArgumentException(
                    "Unsupported type/version found for frequency duration extension: " + frequency.fhirType());
        }
        if (precision == null) {
            ...
            throw new IllegalArgumentException(
                    "The frequency duration precision is invalid. Must be one of (d | w | m | y)");
        }
    }
