...
// import org.opencds.cqf.tooling.library.R4LibraryProcessor;
// import org.opencds.cqf.tooling.library.STU3LibraryProcessor;
...
// import org.opencds.cqf.tooling.terminology.ValueSetsProcessor;
// import org.opencds.cqf.tooling.testcase.TestCaseProcessor;
...
public class IGProcessor {
    ...
    //                    igCanonicalBase =
    // IGUtils.getStu3ImplementationGuideCanonicalBase((org.hl7.fhir.dstu3.model.ImplementationGuide)
    // implementationGuide);
    //                }
    //            }
    //            refreshedLibraryNames = refreshStu3IG(igCanonicalBase, igPath, encoding, includeELM,
    // includeDependencies, includeTerminology,
    ...
    //                if (implementationGuide != null) {
    //                    igCanonicalBase =
    // IGUtils.getR4ImplementationGuideCanonicalBase((org.hl7.fhir.r4.model.ImplementationGuide) implementationGuide);
    //                }
    //            }
    //            refreshedLibraryNames = refreshR4IG(igCanonicalBase, igPath, encoding, includeELM,
    // includeDependencies, includeTerminology,
    //                    includePatientScenarios, versioned, fhirContext);
    //            break;
    //        default:
    ...
    //            TestCaseProcessor.refreshTestCases(FilenameUtils.concat(igPath, testCasePathElement), encoding,
    // fhirContext);
    //        }
    //
    //        bundleIg(refreshedLibraryNames, igPath, encoding, includeELM, includeDependencies, includeTerminology,
    // includePatientScenarios,
    //        versioned, fhirContext, fhirUri);
    //    }
    //
    //    private static ArrayList<String> refreshStu3IG(String igCanonicalBase, String igPath, Encoding
    // outputEncodingEnum, Boolean includeELM, Boolean includeDependencies,
    //            Boolean includeTerminology, Boolean includePatientScenarios, Boolean versioned, FhirContext
    // fhirContext) {
    //        ArrayList<String> refreshedResourcesNames = refreshStu3IgLibraryContent(igCanonicalBase, igPath,
    // outputEncodingEnum, includeELM, versioned, fhirContext);
    //
    //        List<String> refreshedMeasureNames = refreshStu3IgMeasureContent(igPath, outputEncodingEnum, versioned,
    // fhirContext);
    //        refreshedResourcesNames.addAll(refreshedMeasureNames);
    //        return refreshedResourcesNames;
    //    }
    //
    //    private static ArrayList<String> refreshR4IG(String igCanonicalBase, String igPath, Encoding
    // outputEncodingEnum, Boolean includeELM, Boolean includeDependencies,
    //            Boolean includeTerminology, Boolean includePatientScenarios, Boolean versioned, FhirContext
    // fhirContext) {
    //        ArrayList<String> refreshedResourcesNames = refreshR4LibraryContent(igCanonicalBase, igPath,
    // outputEncodingEnum, includeELM, versioned, fhirContext);
    //
    //        List<String> refreshedMeasureNames = refreshR4IgMeasureContent(igPath, outputEncodingEnum, versioned,
    // fhirContext);
    //        refreshedResourcesNames.addAll(refreshedMeasureNames);
    //        return refreshedResourcesNames;
    //    }
    //
    //    public static ArrayList<String> refreshStu3IgLibraryContent(String igCanonicalBase, String igPath, Encoding
    // outputEncoding, Boolean includeELM,
    ...
    //
    //                STU3LibraryProcessor.refreshLibraryContent(igCanonicalBase, path, libraryPath, fhirContext,
    // outputEncoding, versioned);
    ...
    //    }
    //
    //    public static ArrayList<String> refreshR4LibraryContent(String igCanonicalBase, String igPath, Encoding
    // outputEncoding, Boolean includeELM,
    //            Boolean versioned, FhirContext fhirContext) {
    //        System.out.println("Refreshing libraries...");
    //        ArrayList<String> refreshedLibraryNames = new ArrayList<String>();
    ...
    //                String libraryPath = IOUtils.getLibraryPathAssociatedWithCqlFileName(path, fhirContext);
    //
    //                R4LibraryProcessor.refreshLibraryContent(igCanonicalBase, path, libraryPath, fhirContext,
    // outputEncoding, versioned);
    //                refreshedLibraryNames.add(FilenameUtils.getBaseName(path));
    //            } catch (Exception e) {
    //                LogUtils.putException(path, e);
    ...
    //    }
    //
    //    public static ArrayList<String> refreshStu3IgMeasureContent(String igPath, Encoding outputEncoding, Boolean
    // versioned, FhirContext fhirContext) {
    ...
    //    }
    //
    //    public static ArrayList<String> refreshR4IgMeasureContent(String igPath, Encoding outputEncoding, Boolean
    // versioned, FhirContext fhirContext) {
    //        System.out.println("Refreshing measures...");
    //        ArrayList<String> refreshedMeasureNames = new ArrayList<String>();
    //        HashSet<String> measurePaths = IOUtils.getMeasurePaths(fhirContext);
    ...
    //    public static void bundleIg(ArrayList<String> refreshedLibraryNames, String igPath, Encoding encoding, Boolean
    // includeELM,
    //            Boolean includeDependencies, Boolean includeTerminology, Boolean includePatientScenarios, Boolean
    // versioned,
    //            FhirContext fhirContext, String fhirUri) {
    //
    //        bundleMeasures(refreshedLibraryNames, igPath, includeDependencies, includeTerminology,
    // includePatientScenarios, versioned,
    //                fhirContext, fhirUri, encoding);
    //
    //        bundlePlanDefinitions(refreshedLibraryNames, igPath, includeDependencies, includeTerminology,
    // includePatientScenarios, versioned,
    //                fhirContext, fhirUri, encoding);
    //    }
    //
    //    private static void bundleMeasures(ArrayList<String> refreshedLibraryNames, String igPath, Boolean
    // includeDependencies,
    //            Boolean includeTerminology, Boolean includePatientScenarios, Boolean includeVersion, FhirContext
    // fhirContext, String fhirUri,
    //            Encoding encoding) {
    //        // The set to bundle should be the union of the successfully refreshed Measures and Libraries
    //        // Until we have the ability to refresh Measures, the set is the union of existing Measures and
    // successfully refreshed Libraries
    ...
    //                    LogUtils.info("Skipped bundling - no Measure resource found for Library: " +
    // refreshedLibraryName);
    //                    continue;
    //                }
    //
    ...
    // IOUtils.getLibraryPathAssociatedWithCqlFileName(refreshedLibraryFileName, fhirContext);
    //                if (librarySourcePath == null) {
    //                    LogUtils.putException(refreshedLibraryName, new FileNotFoundException("Could not find a
    // Library Resource Associated with: " + refreshedLibraryFileName));
    //                    continue;
    //                }
    //
    ...
    //                String cqlLibrarySourcePath = (cqlLibrarySourcePaths.isEmpty()) ? null :
    // cqlLibrarySourcePaths.get(0);
    //                if (includeTerminology) {
    //                    shouldPersist = shouldPersist
    //                        & bundleValueSets(cqlLibrarySourcePath, igPath, fhirContext, resources, encoding,
    // includeDependencies, includeVersion);
    //                }
    //
    ...
    //                    persistBundle(igPath, bundleDestPath, refreshedLibraryName, encoding, fhirContext, new
    // ArrayList<IAnyResource>(resources.values()), fhirUri);
    //                    bundleFiles(igPath, bundleDestPath, refreshedLibraryName, measureSourcePath,
    // librarySourcePath, fhirContext, encoding, includeTerminology, includeDependencies, includePatientScenarios,
    // includeVersion);
    ...
    //        message += "\r\n" + measurePathLibraryNames.size() + " Measures refreshed, but not bundled (due to
    // issues):";
    ...
    //    }
    //
    //    private static void bundlePlanDefinitions(ArrayList<String> refreshedLibraryNames, String igPath, Boolean
    // includeDependencies,
    //            Boolean includeTerminology, Boolean includePatientScenarios, Boolean includeVersion, FhirContext
    // fhirContext, String fhirUri,
    //            Encoding encoding) {
    ...
    //            String name =
    // FilenameUtils.getBaseName(planDefinitionSourcePath).replace(PlanDefinitionProcessor.ResourcePrefix, "");
    //
    ...
    //                }
    //
    //                Boolean shouldPersist = ResourceUtils.safeAddResource(planDefinitionSourcePath, resources,
    // fhirContext);
    //                shouldPersist = shouldPersist
    //                        & ResourceUtils.safeAddResource(librarySourcePath, resources, fhirContext);
    //
    ...
    //                }
    //
    //                List<String> activityDefinitionPaths =  bundleActivityDefinitions(planDefinitionSourcePath,
    // fhirContext, resources, encoding, includeVersion, shouldPersist);
    //
    //                if (shouldPersist) {
    //                    String bundleDestPath = FilenameUtils.concat(getBundlesPath(igPath), refreshedLibraryName);
    //                    persistBundle(igPath, bundleDestPath, refreshedLibraryName, encoding, fhirContext, new
    // ArrayList<IAnyResource>(resources.values()), fhirUri);
    //                    bundleFiles(igPath, bundleDestPath, refreshedLibraryName, planDefinitionSourcePath,
    // librarySourcePath, fhirContext, encoding, includeTerminology, includeDependencies, includePatientScenarios,
    // includeVersion);
    //                    addActivityDefinitionFilesToBundle(igPath, bundleDestPath, refreshedLibraryName,
    ...
    //        message += "\r\n" + planDefinitionPathLibraryNames.size() + " PlanDefinitions refreshed, but not bundled
    // (due to issues):";
    ...
    //    private static void addRequestAndResponseFilesToBundle(String igPath, String bundleDestPath, String
    // libraryName) {
    //        String bundleDestFilesPath = FilenameUtils.concat(bundleDestPath, libraryName + "-" +
    // bundleFilesPathElement);
    ...
    //                    IOUtils.copyFile(path, FilenameUtils.concat(requestFilesDirectory,
    ...
    //                    IOUtils.copyFile(path, FilenameUtils.concat(responseFilesDirectory,
    // FilenameUtils.getName(path)));
    //                }
    //            }
    //        }
    ...
    //            Map<String, IAnyResource> resources, Encoding encoding, Boolean includeDependencies, Boolean
    // includeVersion) {
    //        Boolean shouldPersist = true;
    //        try {
    //            Map<String, IAnyResource> dependencies = ResourceUtils.getDepValueSetResources(cqlContentPath, igPath,
    // fhirContext, includeDependencies, includeVersion);
    ...
    //    }
    //
    //    public static List<String> bundleActivityDefinitions(String planDefinitionPath, FhirContext fhirContext,
    ...
    //        try {
    //            Map<String, IAnyResource> activityDefinitions =
    ...
    //    }
    //
    //    public static Boolean bundleDependencies(String path, FhirContext fhirContext, Map<String, IAnyResource>
    // resources,
    //            Encoding encoding) {
    //        Boolean shouldPersist = true;
    //        try {
    //            Map<String, IAnyResource> dependencies = ResourceUtils.getDepLibraryResources(path, fhirContext,
    // encoding);
    //
    ...
    //                String dependencyPath = path.replace(currentResourceID,
    // FilenameUtils.getBaseName(resource.getIdElement().getIdPart()));
    ...
    //            Map<String, IAnyResource> resources) {
    //        Boolean shouldPersist = true;
    //        String igTestCasePath = FilenameUtils.concat(FilenameUtils.concat(igPath, testCasePathElement),
    // libraryName);
    //
    ...
    //
    //        try {
    //            List<IAnyResource> testCaseResources = TestCaseProcessor.getTestCaseResources(igTestCasePath,
    // fhirContext);
    ...
    //    }
    //
    //    private static void persistBundle(String igPath, String bundleDestPath, String libraryName, Encoding encoding,
    // FhirContext fhirContext, List<IAnyResource> resources, String fhirUri) {
    ...
    //                LogUtils.info("Resource successfully posted to FHIR server (" + fhirUri + "): " +
    // ((IAnyResource)bundle).getId());
    //            } catch (Exception e) {
    ...
    //    private static void addActivityDefinitionFilesToBundle(String igPath, String bundleDestPath, String
    // libraryName, List<String> activityDefinitionPaths, FhirContext fhirContext, Encoding encoding) {
    //        String bundleDestFilesPath = FilenameUtils.concat(bundleDestPath, libraryName + "-" +
    // bundleFilesPathElement);
    ...
    //        }
    //    }
    //    private static void bundleFiles(String igPath, String bundleDestPath, String libraryName, String
    // resourceFocusSourcePath, String librarySourcePath, FhirContext fhirContext, Encoding encoding, Boolean
    // includeTerminology, Boolean includeDependencies, Boolean includePatientScenarios, Boolean includeVersion) {
    //        String bundleDestFilesPath = FilenameUtils.concat(bundleDestPath, libraryName + "-" +
    // bundleFilesPathElement);
    //        IOUtils.initializeDirectory(bundleDestFilesPath);
    //
    //        IOUtils.copyFile(resourceFocusSourcePath, FilenameUtils.concat(bundleDestFilesPath,
    // FilenameUtils.getName(resourceFocusSourcePath)));
    //        IOUtils.copyFile(librarySourcePath, FilenameUtils.concat(bundleDestFilesPath,
    // FilenameUtils.getName(librarySourcePath)));
    //
    ...
    //        if (includeTerminology) {
    //            try {
    //                Map<String, IAnyResource> valuesets = ResourceUtils.getDepValueSetResources(cqlLibrarySourcePath,
    // igPath, fhirContext, includeDependencies, includeVersion);
    //                if (!valuesets.isEmpty()) {
    //                    Object bundle = BundleUtils.bundleArtifacts(ValueSetsProcessor.getId(libraryName), new
    // ArrayList<IAnyResource>(valuesets.values()), fhirContext);
    ...
    //
    //        if (includeDependencies) {
    //            Map<String, IAnyResource> depLibraries = ResourceUtils.getDepLibraryResources(librarySourcePath,
    // fhirContext, encoding);
    //
    //            //TODO: Needs to be recursive
    //            if (!depLibraries.isEmpty()) {
    //                String depLibrariesID = "library-deps-" + libraryName;
    //                Object bundle = BundleUtils.bundleArtifacts(depLibrariesID, new
    // ArrayList<IAnyResource>(depLibraries.values()), fhirContext);
    //                IOUtils.writeBundle(bundle, bundleDestFilesPath, encoding, fhirContext);
    //            }
    //        }
    //
    ...
    //    public static void bundleTestCaseFiles(String igPath, String libraryName, String destPath, FhirContext
    // fhirContext) {
    //        String igTestCasePath = FilenameUtils.concat(FilenameUtils.concat(igPath, testCasePathElement),
    // libraryName);
    ...
    //                    Optional<String> matchingMeasureReportPath =
    // IOUtils.getMeasureReportPaths(fhirContext).stream()
    ...
    //                        if (!measureReport.getId().startsWith("measurereport") ||
    // !measureReport.getId().endsWith("-expectedresults")) {
    //                            Object measureReportStatus = ResourceUtils.resolveProperty(measureReport, "status",
    // fhirContext);
    //                            String measureReportStatusValue = ResourceUtils.resolveProperty(measureReportStatus,
    // "value", fhirContext).toString();
    //                            if (measureReportStatusValue.equals("COMPLETE")) {
    //                                String expectedResultsId = FilenameUtils.getBaseName(testContentPath) +
    // (FilenameUtils.getBaseName(testContentPath).endsWith("-expectedresults") ? "" : "-expectedresults");
    ...
    //                    }
    //                    else {
    //                        String bundleTestContentDestPath = FilenameUtils.concat(destPath,
    // FilenameUtils.getName(testContentPath));
    ...
    //        }
    //        if (igVersion == null) {
    //            throw new IllegalArgumentException("IG version must be configured in ig.ini or provided as an
    // argument.");
    //        }
    ...
    //                }
    //                else if (line.toLowerCase().contains(STU3SPECIFIER) ||
    // line.toLowerCase().contains(DSTU3SPECIFIER)) {
    ...
    //
    //    private static void ensure(String igPath, Boolean includePatientScenarios, Boolean includeTerminology,
    ...
    //                throw new RuntimeException("Unable to refresh IG.  All Libraries must begin with \"library \": " +
    // cqlContentPath);
    //            }
    ...
    //                        throw new RuntimeException("Convention only allows a single \"_\" and it must be
    // preceeding the IG Version: " + cqlContentPath);
    //                    }
    //                }
    //            }
    //            if (strippedLibraryName.contains("_")) {
    //                throw new RuntimeException("Convention only allows a single \"_\" and it must be preceeding the IG
    // Version: " + cqlContentPath);
    //            }
    //        }
    //    }
    //
    ...
    //        // that resourceDirectories contains a set of proper "resource" directories. Adding non-resource
    // directories
