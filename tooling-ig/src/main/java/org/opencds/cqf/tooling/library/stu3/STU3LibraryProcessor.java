...
public class STU3LibraryProcessor extends LibraryProcessor {
    ...
    protected List<String> refreshLibraries(
            String libraryPath, String libraryOutputDirectory, Boolean shouldApplySoftwareSystemStamp) {
        ...
        for (org.hl7.fhir.r5.model.Library refreshedLibrary : refreshedLibraries) {
            ...
            if (null != filePath) {
                org.hl7.fhir.dstu3.model.Library library =
                        (org.hl7.fhir.dstu3.model.Library) versionConvertor_30_50.convertResource(refreshedLibrary);
    ...
    private void cleanseRelatedArtifactReferences(Library library) {
        ...
        relatedArtifacts.removeIf(ra -> ra.hasResource()
                && ra.getResource().hasReference()
                && unresolvableCodeSystems.contains(ra.getResource().getReference()));
            ...
            if ((relatedArtifact.getType() == RelatedArtifact.RelatedArtifactType.DEPENDSON)
                ...
                if (resourceReference.contains("|")) {
                    if (this.versioned) {
                        ...
                        String curatedResourceReference =
                                resourceReference.substring(0, resourceReference.indexOf("|"));
                        relatedArtifact.getResource().setReference(curatedResourceReference);
                    }
                }
            }
    ...
    private void loadLibrary(
        ...
        try {
            ...
            org.hl7.fhir.r5.model.Library library =
                    (org.hl7.fhir.r5.model.Library) versionConvertor_30_50.convertResource(resource);
