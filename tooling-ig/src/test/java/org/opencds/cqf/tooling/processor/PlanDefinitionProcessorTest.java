...
public class PlanDefinitionProcessorTest {
    ...
    @Test(
            priority = 0,
            description = "Test PlanDefinition processor referencing an IG without any PlanDefinition resources")
    void testEmptyIg() throws IOException {
        ...
        var result = processor.refreshIgPlanDefinitionContent(
                parentContext, IOUtils.Encoding.JSON, false, fhirContext, planDefinitionDir.toString(), false);
        Assert.assertEquals(result.size(), 0);
    }

    @Test(
            priority = 1,
            description = "Test PlanDefinition processor referencing an IG with a very simple PlanDefinition resource")
    void testSimplePlanDefinition() throws IOException {
        ...
        libraryProcessor.refreshIgLibraryContent(
                parentContext, IOUtils.Encoding.JSON, libraryDir.toString(), false, fhirContext, false);
    ...
    @Test(
            priority = 2,
            description = "Test PlanDefinition processor referencing an IG with a more complex PlanDefinition resource")
    void testComplexPlanDefinition() throws IOException {
        ...
        try (Reader reader =
            ...
            var effectiveDateRequirements =
                    (Library) ((PlanDefinition) planDefinition).getContained().get(0);
    ...
    private void boilerplateIg() throws IOException {
        ...
        String igJson =
                "{\"resourceType\":\"ImplementationGuide\", \"id\":\"test-ig\", \"url\": \"http://fhir.org/guides/example/test-ig/ImplementationGuide/fhir.example.test-ig\", \"packageId\":\"fhir.example.test-ig\", \"fhirVersion\": [\"4.0.1\"]}";
    ...
    private void buildSimpleIg() throws IOException {
        ...
        String libraryJson =
                "{\"resourceType\":\"Library\", \"id\":\"Simple\", \"version\": \"1.0\", \"name\": \"Simple\", \"type\": { \"coding\": [ { \"system\": \"http://terminology.hl7.org/CodeSystem/library-type\", \"code\": \"logic-library\" } ] }, \"content\": [ { \"id\": \"ig-loader-Simple.cql\" } ]}";
        Path libraryFile = libraryDir.resolve("Simple.json");
        Files.writeString(libraryFile, libraryJson);

        String planDefinitionJson =
                "{\"resourceType\":\"PlanDefinition\", \"id\":\"Simple\", \"version\": \"1.0\", \"name\": \"Simple\", \"library\": [ \"http://fhir.org/guides/example/test-ig/Library/Simple\" ] } ]}";
    ...
    private void buildComplexIg() throws IOException {
        ...
        String valueSetJson =
                "{\"resourceType\":\"ValueSet\", \"id\":\"office-visit\", \"name\": \"OfficeVisit\", \"url\": \"http://fhir.org/guides/example/test-ig/ValueSet/office-visit\", \"expansion\": { \"contains\": [ { \"system\": \"http://snomed.info/sct\", \"code\": \"185463005\", \"display\": \"Visit out of hours (procedure)\" } ] } }";
        ...
        Files.createDirectory(libraryDir);
        String libraryJson =
                "{\"resourceType\":\"Library\", \"id\":\"Complex\", \"version\": \"1.0\", \"name\": \"Complex\", \"type\": { \"coding\": [ { \"system\": \"http://terminology.hl7.org/CodeSystem/library-type\", \"code\": \"logic-library\" } ] }, \"content\": [ { \"id\": \"ig-loader-Complex.cql\" } ]}";
        Path libraryFile = libraryDir.resolve("Complex.json");
        Files.writeString(libraryFile, libraryJson);

        String planDefinitionJson =
                "{\"resourceType\":\"PlanDefinition\", \"id\":\"Complex\", \"version\": \"1.0\", \"name\": \"Complex\", \"library\": [ \"http://fhir.org/guides/example/test-ig/Library/Complex\" ], \"action\": [ { \"condition\": [ { \"kind\": \"applicability\", \"expression\": { \"language\": \"text/cql.identifier\", \"expression\": \"OfficeVisitEncounters\" } } ] } ] }";
