...
public class ExtractMatBundleIT {
    ...
    void testDSTU3ExtractMatBundleOperation() {
        ...
        dstu3MatMeasure.setLibrary(
                Collections.singletonList(new org.hl7.fhir.dstu3.model.Reference("Library/dstu3-test-mat-library")));
    ...
    void testR4ExtractMatBundleOperation() {
        ...
        r4MatMeasure.setLibrary(
                Collections.singletonList(new org.hl7.fhir.r4.model.CanonicalType("Library/r4-test-mat-library")));
