...
public class RefreshLibraryOperationIT extends RefreshTest {
    ...
    private void testRefreshOverwriteLibraries() throws Exception {
        ...
        String args[] = {
            ...
            "-cql=" + targetDirectory + separator + "input" + separator + "pagecontent" + separator + "cql" + separator
    ...
    private void testRefreshOutputDirectory() throws Exception {
        ...
        String args[] = {
            ...
            "-cql=" + resourceDirPath + separator + "input" + separator + "pagecontent" + separator + "cql" + separator
                    + "EXM124_FHIR4-8.2.000.cql",
            "-e=json",
            "-fv=4.0.1"
        };
