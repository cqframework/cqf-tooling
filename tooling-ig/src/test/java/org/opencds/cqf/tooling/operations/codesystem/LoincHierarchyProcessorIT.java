...
public class LoincHierarchyProcessorIT {
    ...
    // Simulates the LOINC hierarchy API at
    ...
    void setup() {
        ...
        testClient
                ...
                .respond(response().withBody(COCAINE_URINE_QUERY_RESPONSE));
        ...
        testClient
                ...
                .respond(response().withBody(CANNABINOID_QUERY_RESPONSE));
    }
    ...
    void testSimpleQuery() {
        ...
        Assert.assertTrue(
                ((ValueSet) returnVs).getExpansion().getContainsFirstRep().hasSystem());
        Assert.assertEquals(
                ((ValueSet) returnVs).getExpansion().getContainsFirstRep().getSystem(), Terminology.LOINC_SYSTEM_URL);
