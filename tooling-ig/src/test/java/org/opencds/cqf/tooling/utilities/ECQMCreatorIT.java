...
public class ECQMCreatorIT {
    ...
    private Measure refreshMeasure(String primaryLibraryPath, String measurePath) throws IOException {
        ...
        return refreshProcessor.refreshMeasure(
                measureToConvert, libraryManager, translator.getTranslatedLibrary(), cqlCompilerOptions);
    }
    ...
    private List<DataRequirement> StartMatOutputTest(String matBundleName, String measureLibraryName) {
        ...
        o.execute(new String[] {
            "-ExtractMATBundle",
            this.getClass()
                    .getResource("ecqm-content-r4-2021/bundles/" + matBundleName)
                    .getFile()
        });
        ...
        try {
            Measure measure = refreshMeasure(
                    "ecqm-content-r4-2021/input/cql/" + measureLibraryName + ".cql",
                    "ecqm-content-r4-2021/input/resources/measure/" + measureLibraryName + ".json");
            assertTrue(null != measure);
            // Extract data requirements from the measure:
            Extension e = measure.getExtensionByUrl(
                    "http://hl7.org/fhir/uv/crmi/StructureDefinition/crmi-effectiveDataRequirements");
            assertTrue(null != e);
            Library effectiveDataRequirements =
                    (Library) measure.getContained(e.getValueCanonicalType().getValue());
    ...
    public void TestCMS816HIR() {
        List<DataRequirement> drs =
                StartMatOutputTest("HH-01FHIR-v0-0-010-FHIR-4-0-1.json", "HospitalHarmSevereHypoglycemiaFHIR");
        // TODO: Measure-specific validation of data requirements content
    ...
    public void TestCMS190FHIR() {
        List<DataRequirement> drs = StartMatOutputTest(
    ...
    public void TestCMS108FHIR() {
        List<DataRequirement> drs =
                StartMatOutputTest("CMS108-v0-0-003-FHIR-4-0-1.json", "VenousThromboembolismProphylaxisFHIR");
        // TODO: Measure-specific validation of data requirements content
        List<String> edrs = new ArrayList<String>();
        edrs.add("ServiceRequest");
        edrs.add("Procedure");
    ...
    public void TestCMS147FHIR() {
        List<DataRequirement> drs = StartMatOutputTest(
                "CMS147FHIR-v0-0-001-FHIR-4-0-1.json", "PreventiveCareandScreeningInfluenzaImmunizationFHIR");
        // TODO: Measure-specific validation of data requirements content
        List<String> edrs = new ArrayList<String>();
    ...
    public void TestCMS159FHIR() {
        List<DataRequirement> drs =
                StartMatOutputTest("CMS159FHIR-v0-0-001-FHIR-4-0-1.json", "DepressionRemissionatTwelveMonthsFHIR");
        // TODO: Measure-specific validation of data requirements content
        List<String> edrs = new ArrayList<String>();
        edrs.add("ServiceRequest");
        edrs.add("Observation");
    ...
    public void TestCMS125FHIR() {
        List<DataRequirement> drs =
                StartMatOutputTest("CMS125FHIR-v0-0-004-FHIR-4-0-1.json", "BreastCancerScreeningsFHIR");
        // TODO: Measure-specific validation of data requirements content
        List<String> edrs = new ArrayList<String>();
        edrs.add("ServiceRequest");
        edrs.add("Procedure");
    ...
    public void TestCMS104FHIR() {
        List<DataRequirement> drs =
                StartMatOutputTest("CMS104FHIR-v0-0-001-FHIR-4-0-1.json", "DischargedonAntithromboticTherapyFHIR");
        // TODO: Measure-specific validation of data requirements content
    ...
    public void TestCMS130FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS130FHIR-v0-0-002-FHIR-4-0-1.json", "ColorectalCancerScreeningsFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestIPSSwithBPHdxFHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs = StartMatOutputTest(
                    "IPSS with BPH dxFHIR-v0-0-004-FHIR-4-0-1.json",
                    "UrinarySymptomScoreChange6to12MonthsAfterDiagnosisofBenignProstaticHyperplasiaFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestHIVScreeningFHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("HIV ScreeningFHIR-v0-0-003-FHIR-4-0-1.json", "HIVScreeningFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestDEXAScreenProstateFHIR() {
        if (FULL_REGRESSION) {
            ...
            List<DataRequirement> drs = StartMatOutputTest(
                    "DEXA screen prostateFHIR-v0-0-005-FHIR-4-0-1.json",
    ...
    public void TestCMS249FHIR() {
        if (FULL_REGRESSION) {
            ...
            // NOTE: This is a 2021-AUFHIR measure, this is the test created using TestCMS125FHIR as template
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS249FHIR-v0-0-001-FHIR-4-0-1.json", "AppropriateDXAScansForWomenUnder65FHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS177FHIR() {
        if (FULL_REGRESSION) {
            ...
            // NOTE: This is a 2021-AUFHIR measure, this is the test created using TestCMS125FHIR as template
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS177FHIR-v0-0-002-FHIR-4-0-1.json",
    ...
    public void TestCMS165FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS165FHIR-v0-0-003-FHIR-4-0-1.json", "ControllingHighBloodPressureFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS157FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS157FHIR-v0-0-006-FHIR-4-0-1.json", "OncologyPainIntensityQuantifiedFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS155FHIR() {
        if (FULL_REGRESSION) {
            ...
            // NOTE: This is a 2021-AUFHIR measure, this is the test created using TestCMS125FHIR as template
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS155FHIR-v0-0-002-FHIR-4-0-1.json",
    ...
    public void TestCMS153FHIR() {
        if (FULL_REGRESSION) {
            ...
            // NOTE: This is a 2021-AUFHIR measure, this is the test created using TestCMS125FHIR as template
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS153FHIR-v0-0-002-FHIR-4-0-1.json", "ChlamydiaScreeningforWomenFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS149FHIR() {
        if (FULL_REGRESSION) {
            ...
            // NOTE: This is a 2021-AUFHIR measure, this is the test created using TestCMS125FHIR as template
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS149FHIR-v0-0-002-FHIR-4-0-1.json", "DementiaCognitiveAssessmentFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS146FHIR() {
        if (FULL_REGRESSION) {
            ...
            // NOTE: This is a 2021-AUFHIR measure, this is the test created using TestCMS125FHIR as template
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS146FHIR-v0-0-001-FHIR-4-0-1.json", "AppropriateTestingforPharyngitisFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS145FHIR() {
        if (FULL_REGRESSION) {
            ...
            // NOTE: This is a 2021-AUFHIR measure, this is the test created using TestCMS125FHIR as template
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS145FHIR-v0-0-007-FHIR-4-0-1.json", "CADBetaBlockerTherapyPriorMIorLVSDFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS144FHIR() {
        if (FULL_REGRESSION) {
            ...
            // NOTE: This is a 2021-AUFHIR measure, this is the test created using TestCMS125FHIR as template
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS144FHIR-v0-0-005-FHIR-4-0-1.json", "HFBetaBlockerTherapyforLVSDFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS143FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS143FHIR-v0-0-001-FHIR-4-0-1.json", "POAGOpticNerveEvaluationFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS142FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS142FHIR-v0-0-004-FHIR-4-0-1.json", "DRCommunicationWithPhysicianManagingDiabetesFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS139FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS139FHIR-v0-0-001-FHIR-4-0-1.json", "FallsScreeningforFutureFallRiskFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS138FHIR() {
        if (FULL_REGRESSION) {
            ...
            // NOTE: This is a 2021-AUFHIR measure, this is the test created using TestCMS125FHIR as template
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS138FHIR-v0-0-001-FHIR-4-0-1.json",
                    "PreventiveCareandScreeningTobaccoUseScreeningandCessationInterventionFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS137FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS137FHIR-v0-0-001-FHIR-4-0-1.json",
                    "InitiationandEngagementofAlcoholandOtherDrugDependenceTreatmentFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS136FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS136FHIR-v0-0-001-FHIR-4-0-1.json", "FollowUpCareforChildrenPrescribedADHDMedicationADDFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS135FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS135FHIR-v0-0-013-FHIR-4-0-1.json", "HFACEIorARBorARNIforLVSDFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS133FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS133FHIR-v0-0-009-FHIR-4-0-1.json", "Cataracts2040BCVAwithin90DaysFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS131FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS131FHIR-v0-0-003-FHIR-4-0-1.json", "DiabetesEyeExamFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS129FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS129FHIR-v0-0-005-FHIR-4-0-1.json", "ProstateCaAvoidanceBoneScanOveruseFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS128FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS128FHIR-v0-0-001-FHIR-4-0-1.json", "AntidepressantMedicationManagementFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS124FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS124FHIR-v0-0-003-FHIR-4-0-1.json", "CervicalCancerScreeningFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS117FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS117FHIR-v0-0-001-FHIR-4-0-1.json", "ChildhoodImmunizationStatusFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS90FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS90FHIR-v0-0-005-FHIR-4-0-1.json", "FunctionalStatusAssessmentsforHeartFailureFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS75FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS75FHIR-v0-0-001-FHIR-4-0-1.json", "ChildrenWhoHaveDentalDecayorCavitiesFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS74FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS74FHIR-v0-0-004-FHIR-4-0-1.json",
    ...
    public void TestCMS72FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS72FHIR-v0-0-003-FHIR-4-0-1.json", "AntithromboticTherapyByEndofHospitalDay2FHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS69FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS69FHIR-v0-0-004-FHIR-4-0-1.json", "PCSBMIScreenAndFollowUpFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS68FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS68FHIR-v0-0-004-FHIR-4-0-1.json", "DocumentationofCurrentMedicationsFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS66FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs = StartMatOutputTest(
                    "CMS66FHIR-v0-0-002-FHIR-4-0-1.json", "FunctionalStatusAssessmentforTotalKneeReplacementFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS50FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS50FHIR-v0-0-013-FHIR-4-0-1.json", "CRLReceiptofSpecialistReportFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS22FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS22FHIR-v0-0-007-FHIR-4-0-1.json", "PreventiveBPScreeningFollowUpFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestCMS2FHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs =
                    StartMatOutputTest("CMS2FHIR-v0-0-002-FHIR-4-0-1.json", "PCSDepressionScreenAndFollowUpFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestBCG4NonmuscleInvasiveBCaFHIR() {
        if (FULL_REGRESSION) {
            List<DataRequirement> drs = StartMatOutputTest(
                    "BCG 4 nonmuscle invasive BCaFHIR-v0-0-006-FHIR-4-0-1.json",
                    "IntravesicalBacillusCalmetteGuerinForNonmuscleInvasiveBladderCancerFHIR");
            // TODO: Measure-specific validation of data requirements content
        }
    }
    ...
    public void TestBCSComponent() {
        try {
            Measure measure = refreshMeasure(
                    "CompositeMeasures/cql/BCSComponent.cql",
    ...
    public void TestCCSComponent() {
        try {
            Measure measure = refreshMeasure(
                    "CompositeMeasures/cql/CCSComponent.cql",
    ...
    public void TestHBPComponent() {
        try {
            Measure measure = refreshMeasure(
                    "CompositeMeasures/cql/HBPComponent.cql",
    ...
    public void TestPVSComponent() {
        try {
            Measure measure = refreshMeasure(
                    "CompositeMeasures/cql/PVSComponent.cql",
    ...
    public void TestTSCComponent() {
        try {
            Measure measure = refreshMeasure(
                    "CompositeMeasures/cql/TSCComponent.cql",
    ...
    public void TestECQMCreator() {
        ...
        try {
            Measure measure = refreshMeasure(
                    "CompositeMeasures/cql/EXM124-9.0.000.cql", "/ecqm/resources/measure-EXM124-9.0.000.json");
            assertTrue(null != measure);
            logger.debug(measureToString(measure));
        } catch (IOException ioException) {
            ioException.printStackTrace();
    ...
    public void TestECQMCreatorDataRequirements() {
        // TODO - translate measure into ELM measure then call creator with that measure
        String libraryPath =
                "CompositeMeasures/cql/BCSComponent.cql"; // EXM124-9.0.000.cql";//library-EXM124-9.0.000.json";
        try {
            ...
            InputStream inputStream = this.getClass()
                    .getResourceAsStream(
                            "CompositeMeasures/resources/BCSComponent-v0-0-001-FHIR-4-0-1.xml"); // "/ecqm/resources/measure-EXM124-9.0.000.json");
            Measure measureToConvert = xmlParser.parseResource(Measure.class, inputStream);

            //            Measure measureToConvert = parser.parseResource(Measure.class, inputStream);
            MeasureRefreshProcessor refreshProcessor = new MeasureRefreshProcessor();
            Measure returnMeasure = refreshProcessor.refreshMeasure(
                    measureToConvert, libraryManager, translator.getTranslatedLibrary(), cqlCompilerOptions);
    ...
    private static void cacheLibrary(CompiledLibrary library) {
        // Add the translated library to the library manager (NOTE: This should be a "cacheLibrary" call on the
        // LibraryManager, available in 1.5.3+)
        // Without this, the data requirements processor will try to load the current library, resulting in a
        // re-translation
    ...
    public static CqlTranslator createTranslator(NamespaceInfo namespaceInfo, String libraryName) throws IOException {
        File translationTestFile = new File(Objects.requireNonNull(ECQMCreatorIT.class.getResource(libraryName))
                .getFile());
        reset();
