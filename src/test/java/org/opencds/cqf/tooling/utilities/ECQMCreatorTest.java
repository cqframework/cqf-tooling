...
public class ECQMCreatorTest {
    ...
    public static Object[][] matMeasures(){
        ...
        return new Object [][] {
            ...
            {"HybridHWRFHIR-v1-3-001-FHIR-4-0-1.json", "HybridHWRFHIR"},
            ...
            {"CMS149FHIR-v0-0-002-FHIR-4-0-1.json", "DementiaCognitiveAssessmentFHIR"},
            ...
            {"CMS144FHIR-v0-0-005-FHIR-4-0-1.json", "HFBetaBlockerTherapyforLVSDFHIR"},
            {"CMS143FHIR-v0-0-001-FHIR-4-0-1.json", "POAGOpticNerveEvaluationFHIR"},
            {"CMS129FHIR-v0-0-005-FHIR-4-0-1.json", "ProstateCaAvoidanceBoneScanOveruseFHIR"},
            {"CMS128FHIR-v0-0-001-FHIR-4-0-1.json", "AntidepressantMedicationManagementFHIR"},
            {"CMS127FHIR-v0-0-001-FHIR-4-0-1.json", "PneumococcalVaccinationStatusforOlderAdultsFHIR"},
            {"CMS124FHIR-v0-0-003-FHIR-4-0-1.json", "CervicalCancerScreeningFHIR"},
            {"CMS74FHIR-v0-0-004-FHIR-4-0-1.json", "PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR"},
            {"CMS72FHIR-v0-0-003-FHIR-4-0-1.json", "AntithromboticTherapyByEndofHospitalDay2FHIR"},
            {"CMS69FHIR-v0-0-004-FHIR-4-0-1.json", "PCSBMIScreenAndFollowUpFHIR"},
