...
public class Terminology {
    ...
    public static final String CPG_COMPUTABLE_VS_PROFILE_URL =
            "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-computablevalueset";
    public static final String CPG_EXECUTABLE_VS_PROFILE_URL =
            "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-executablevalueset";
    public static final String CPG_PUBLISHABLE_VS_PROFILE_URL =
    ...
    public static final String KNOWLEDGE_CAPABILITY_EXT_URL =
            "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-knowledgeCapability";
    public static final String KNOWLEDGE_REPRESENTATION_LEVEL_EXT_URL =
            "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-knowledgeRepresentationLevel";
    public static final String USAGE_WARNING_EXT_URL =
            "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-usageWarning";
    public static final String DEFAULT_USAGE_WARNING_VALUE =
