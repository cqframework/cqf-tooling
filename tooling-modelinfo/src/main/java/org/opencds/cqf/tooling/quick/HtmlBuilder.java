...
public class HtmlBuilder {
    ...
    public HtmlBuilder buildLegend() {
        html.append(String.format(
                "<p>%s = Must Support, %s = Is Modifier, %s = QiCore defined extension</p>\n",
    ...
    public HtmlBuilder buildRow(
        ...
        String row = String.format(
                ...
                isModifier ? modifierIcon : "",
                qicoreExt ? extensionIcon : "",
                field,
                card,
                type,
                description);
    ...
    public static String buildBinding(String href, String label, String strength) {
        ...
        switch (strength) {
            case "required":
                binding +=
                        "(<a href='http://hl7.org/fhir/STU3/terminologies.html#required' target='_blank'>required</a>)";
                break;
            case "extensible":
                binding +=
                        "(<a href='http://hl7.org/fhir/STU3/terminologies.html#extensible' target='_blank'>extensible</a>)";
                break;
            case "preferred":
                binding +=
                        "(<a href='http://hl7.org/fhir/STU3/terminologies.html#preferred' target='_blank'>preferred</a>)";
                break;
            case "example":
                binding +=
                        "(<a href='http://hl7.org/fhir/STU3/terminologies.html#example' target='_blank'>example</a>)";
                break;
        }
        return binding;
    }
    ...
    // field, card, type, description, binding
    //        );
    //        html.append(row);
    //        return this;
    //    }
