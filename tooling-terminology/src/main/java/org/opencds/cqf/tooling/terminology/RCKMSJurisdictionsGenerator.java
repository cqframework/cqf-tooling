    ...
    public void execute(String[] args) {
        ...
        for (String arg : args) {
            ...
            switch (flag.replace("-", "").toLowerCase()) {
                ...
                case "idcol":
                case "ic":
                    idCol = Integer.valueOf(value);
                    break;
                case "namecol":
                case "nc":
                    nameCol = Integer.valueOf(value);
                    break;
                case "typecol":
                case "tc":
                    typeCol = Integer.valueOf(value);
                    break;
                case "statecol":
                case "sc":
                    stateCol = Integer.valueOf(value);
                    break;
                case "postalcodeCol":
                case "pc":
                    postalcodeCol = Integer.valueOf(value);
                    break;
                default:
    ...
    public void convertStateToCode() {
        switch (phaState) {
            ...
            case "Virginia":
                phaState = "VA";
                break;
            case "Virgin Islands of the U.S.":
                phaState = "VI";
                break;
            case "Virgin Islands":
                phaState = "VI";
            ...
            case "Wyoming":
                ...
                break;
            default:
                throw new IllegalArgumentException("Unknown State: " + phaState);
        }
    }
}
