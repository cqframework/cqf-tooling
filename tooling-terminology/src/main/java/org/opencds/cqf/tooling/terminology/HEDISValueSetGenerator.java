...
public class HEDISValueSetGenerator extends FlatMultiValueSetGeneratorBase {
    ...
    private static final String outputPath =
            "src/main/resources/org/opencds/cqf/tooling/terminology/output/hedis"; // -outputpath (-op)
    ...
    private static final String valueSetIdentifierSystem =
            "urn:ietf:rfc:3986"; // -valuesetidentifiersystem (-vsis) // ValueSet.Identifier System
