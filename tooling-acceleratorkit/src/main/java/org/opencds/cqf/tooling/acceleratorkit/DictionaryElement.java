...
public class DictionaryElement {
    ...
    private String
            type; // Image, Note, QR Code, Text, Date, Checkbox, Calculation, Integer, MC (select one), MC (select
    // multiple), Toaster message
    ...
    public void setMasterDataElementPath(String masterDataElementPath) {
        this.masterDataElementPath = masterDataElementPath;
    }
    ...
    public String getBaseProfile() {
        ...
        if (this.baseProfile != null
                && !this.baseProfile.isEmpty()
                && !this.baseProfile.toLowerCase().equals("fhir")) {
            return this.baseProfile;
        }
        return String.format(
                "http://hl7.org/fhir/StructureDefinition/%s",
                this.getFhirElementPath().getResourceType());
    }
    ...
    public String getCustomProfileId() {
        return this.customProfileId;
    }

    public void setCustomProfileId(String customProfileId) {
        this.customProfileId = customProfileId;
    }

    private String additionalFHIRMappingDetails;

    public String getAdditionalFHIRMappingDetails() {
        return this.additionalFHIRMappingDetails;
    }

    public void setAdditionalFHIRMappingDetails(String additionalFHIRMappingDetails) {
        this.additionalFHIRMappingDetails = additionalFHIRMappingDetails;
    }

    private String customValueSetName;

    public String getCustomValueSetName() {
        return this.customValueSetName;
    }
    ...
    public String getExtensionNeeded() {
        return this.extensionNeeded;
    }

    public void setExtensionNeeded(String extensionNeeded) {
        this.extensionNeeded = extensionNeeded;
    }

    private String terminologyIdentifier;

    public String getTerminologyIdentifier() {
        return this.terminologyIdentifier;
    }

    public void setTerminologyIdentifier(String terminologyIdentifier) {
