...
//            System.out.println("No paths found for the Directory " + path);
    ...
    private static Set<String> cqlLibraryPaths = new LinkedHashSet<String>();
    ...
    private static Set<String> terminologyPaths = new LinkedHashSet<String>();
    ...
    private static Set<String> libraryPaths = new LinkedHashSet<String>();
...
//        }
    ...
    private static Set<String> measurePaths = new LinkedHashSet<String>();
    ...
    private static Set<String> measureReportPaths = new LinkedHashSet<String>();
    ...
    private static Set<String> questionnairePaths = new LinkedHashSet<String>();
    ...
    private static Set<String> activityDefinitionPaths = new LinkedHashSet<String>();
