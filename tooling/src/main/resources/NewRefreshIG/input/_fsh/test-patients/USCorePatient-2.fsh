...
Instance: USCorePatient-2-height
InstanceOf: Observation
Usage: #example
* meta.profile[+] = "http://hl7.org/fhir/StructureDefinition/bodyheight"
* valueQuantity = 69.2 'in' "in" // Avg height according to Diasabled World
* code = $loinc#8302-2 "Body height"
* status = #final
* subject = Reference(Patient/USCorePatient-2)
* effectiveDateTime = "2023-02-27T00:00:00-00:00"
//* category = $observation-category#vital-signs "Vital Signs"

Instance: USCorePatient-2-weight
InstanceOf: Observation
Usage: #example
...
* subject = Reference(Patient/USCorePatient-2) "Amy Shaw"
...
Instance: encounter-outpatient-USCorePatient-2
...
* participant
  ...
  * individual = Reference(Practitioner/order-provider-USCorePatient-2)
  
Instance: order-provider-USCorePatient-2
...
* subject = Reference(Patient/USCorePatient-2)
* encounter = Reference(Encounter/encounter-outpatient-USCorePatient-2)
...
* requester = Reference(Practitioner/order-provider-USCorePatient-2)
